  ...
  return (
    <Wrapper className="section-center">
      <article className="content">
        <h1>KalaKriti</h1>
        <h2>E-Commerce for Artisans</h2>
        <p>
          Let's work to create a society where handcrafted goods are respected
          and craftsmen are given the credit they deserve for their talents.
        </p>
